...
(function() {
  var HttpCordovaWrapper;

  module.exports = HttpCordovaWrapper = (function() {
    var Http;

    function HttpCordovaWrapper(applicationName) {
    ...
    HttpCordovaWrapper.prototype.resquest = function(params, callback) {
    ...
    HttpCordovaWrapper.prototype.redirect = function(params, callback) {
      var url, webview;
      url = params.scheme + "://" + params.host + ":" + params.port + params.path;
    ...
    return HttpCordovaWrapper;

  })();

}).call(this);

//# sourceMappingURL=HttpCordovaWrapper.js.map
